...
const About = () => {
  return (
    <section className='py-12'>
      <Title title={'about'} />
      <p className='text-gray-900 dark:text-white text-md mb-2'>
        I am a Frontend Developer with a passion for creating interactive and modern web applications. I have knowledge of HTML, CSS and JavaScript,
